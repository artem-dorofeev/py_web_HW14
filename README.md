...
1. poetry add sphinx(в проект не ставимо)
    sphinx-quickstart - це команда для створення нового проекту документації
    sphinx-build - це команда для складання документації
    sphinx-apidoc - це команда для автоматичної генерації документації з модулів Python
    sphinx-autogen - це команда, яку варто використовувати для генерації документації на основі шаблонів

2. встановимо пакет Sphinx у наш проект у вигляді dev залежності
    poetry add sphinx -G dev
    sphinx-quickstart docs

3. Налаштування конфігурації
    cd docs   У редакторі відкриємо файл docs/conf.py

4. Описуємо структуру документації​
    Всередині файлу docs/index.rst нам потрібно описати структуру документації нашого проекту
    Додаємо docstrings

5. Створюємо документацію
    .\make.bat html
